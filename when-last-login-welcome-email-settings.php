...
<tr>
    <th><?php echo esc_html__( 'Welcome Email Subject', 'when-last-login-welcome-email' ); ?></th>
    <td>
        <input type='text' style='width: 300px;' name='wll_we_subject' value='<?php echo esc_attr( $subject ); ?>' />
    </td>
</tr>
<tr>
    <th><?php echo esc_html__( 'Welcome Email Logo', 'when-last-login-welcome-email' ); ?></th>
    <td>
        <input type='text' style='width: 300px;' name='wll_we_logo' id='wll_we_logo' value='<?php echo esc_url( $logo ); ?>' />
        <button class='button' id='wll_we_upload_media'><?php echo esc_html__( 'Upload Logo', 'when-last-login-welcome-email' ); ?></button>
    </td>
</tr>
<tr>
    <th><?php echo esc_html__( 'Welcome Email Body', 'when-last-login-welcome-email' ); ?></th>
    <td>
        <textarea name='wll_we_body' rows='7' style='width: 50%'><?php echo esc_textarea( strip_tags( $body, '<p>' ) ); ?></textarea>
        <small class='description'>
            <p><?php echo esc_html__( 'The following tags can be used: ', 'when-last-login-welcome-email' ); ?></p>
            <code>**site_name**</code><code>**website_name**</code><code>**mail_subject**</code><code>**footer_credit**</code>
        </small>
    </td>
</tr>
<tr>
    <th><?php echo esc_html__( 'Welcome Email Footer Credit', 'when-last-login-welcome-email' ); ?></th>
    <td>
...
<tr>
    <th>
        ...
        <input type="submit" name="wll_we_save_settings" class="button-primary" value="<?php echo esc_attr__( 'Save Settings', 'when-last-login-welcome-email' ); ?>" />
    </th>
    <td></td>
</tr>
